...
# regresión utilizando el método de todos los subconjuntos para construir un modelo de RLM para el ejemplo con el conjunto de datos mtcars.
...
combinaciones <- regsubsets(hp ~ ., data = datos, nbest = 1, nvmax = 16,
                            method = "exhaustive")
